...
if __name__ == "__main__":
    ...
    parser.add_argument("--predict_task", default='../ISTEX_MentalRotation/title_sem_exp_mlt_pairs', type=str)
    parser.add_argument("--task_out", default='score_mlt_title_pairs.csv', type=str)
    ...
    parser.add_argument("--estimator", default='sensim_distance_model.pickle', type=str)
    ...
    if args.evaluate:
        ...
        res = pd.read_csv(args.predict_task, sep='~', header=0)
        ...
        res.to_csv(args.task_out, index=False, sep='\t')
